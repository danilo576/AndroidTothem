...
@Composable
fun BrandOrCategorySelectionScreenPreviewSmall() {
    BrandOrCategoryContent(
        selectedFilterType = FilterType.BRAND,
        onFilterTypeSelect = {},
        onBack = {},
        onClose = {}
    )
...
@Composable
fun BrandOrCategorySelectionScreenPreviewMedium() {
    BrandOrCategoryContent(
...
@Composable
fun BrandOrCategorySelectionScreenPreviewLarge() {
    BrandOrCategoryContent(
        selectedFilterType = FilterType.BRAND,
        onFilterTypeSelect = {},
        onBack = {},
